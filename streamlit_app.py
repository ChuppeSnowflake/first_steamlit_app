...
def get_fruityvice_data(param_fruit_choice):
  fruityvice_response = requests.get("https://fruityvice.com/api/fruit/" + param_fruit_choice)
...
def insert_row_wnoflake(new_fruit):
    with my_cnx_cursor() as my_cur:
      ...
      return "Thankls for adding " + my_fruit
